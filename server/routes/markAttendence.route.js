...
router.route("/delete-attendence-by-id").delete(actions.deleteStudentAttendenceById);
router.route("/delete-attendencerecord-by-id").delete(actions.deleteStudentAttendenceRecordById);
router.route("/delete-attendencerecord-by-date").delete(actions.deleteStudentAttendenceRecordByDate);
